  ...
  return (
   ...
   >
      <Link href={`/movie/${result.id}`}>
        ...
        width={500} height={300} alt="movie-image" className="sm:rounded-t-lg group-hover:opacity-80 transition duration-200"
        placeholder='blur' blurDataURL='www.google.com'
